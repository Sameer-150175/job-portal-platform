...
const users = [];
const records = [
  { id: randomUUID(), title: "Demo application", status: "active", owner: "demo", priority: "medium", createdAt: new Date().toISOString() }
];
...
app.get("/api/health", (req, res) => {
  res.json({ status: "ok", service: "Job Portal Platform", uptime: process.uptime() });
});
...
app.listen(port, () => {
  console.log("Job Portal Platform API listening on " + port);
});
