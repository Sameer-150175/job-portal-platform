...
Job Portal Platform is a push-ready full stack portfolio repository with authentication, protected APIs, dashboard UI, Docker support, CI workflow, and professional documentation.
